...
window.Dropdown = __webpack_require__(/*! bootstrap/js/dist/dropdown */ "./node_modules/bootstrap/js/dist/dropdown.js");
...
function addButtons(container, textarea) {
  ...
  {
    var ddm = el('div', 'dropdown-menu dropdown-menu-right p-1 smiley-dropdown border');
    ddm.style.width = '300px';
    var b = el('button', 'btn btn-outline-dark btn-xs dropdown-toggle');
    b.setAttribute('data-bs-toggle', 'dropdown');
    b.setAttribute('title', 'Smilies');
    b.append(el('span', 'fa fa-face-smile'));
    var _group = el('div', 'btn-group btn-group-xs mr-2 d-lg-none');
    _group.append(b);
    _group.append(ddm);
    toolbar.append(_group);
    var dd = new Dropdown(b);
    addSmilies(ddm, textarea, false);
  }
}
function addSmilies(container, textarea) {
  var more = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
...
var ArticleEmbedTag = /*#__PURE__*/function (_wcp$Tags$Tag) {
  function ArticleEmbedTag() {
    ...
    return _callSuper(this, ArticleEmbedTag, ['athumb']);
  }
  _inherits(ArticleEmbedTag, _wcp$Tags$Tag);
  return _createClass(ArticleEmbedTag, [{
    key: "FormatResult",
...
var DownloadEmbedTag = /*#__PURE__*/function (_wcp$Tags$Tag2) {
  function DownloadEmbedTag() {
    ...
    return _callSuper(this, DownloadEmbedTag, ['dlthumb']);
  }
  _inherits(DownloadEmbedTag, _wcp$Tags$Tag2);
  return _createClass(DownloadEmbedTag, [{
    key: "FormatResult",
    value: function FormatResult(parser, data, state, scope, options, text) {
      var id = parseInt(text, 10);
      if (!id) return null;
...
var MapEmbedTag = /*#__PURE__*/function (_wcp$Tags$Tag3) {
  function MapEmbedTag() {
    ...
    return _callSuper(this, MapEmbedTag, ['mthumb']);
  }
  _inherits(MapEmbedTag, _wcp$Tags$Tag3);
  return _createClass(MapEmbedTag, [{
    key: "FormatResult",
    value: function FormatResult(parser, data, state, scope, options, text) {
      var id = parseInt(text, 10);
      if (!id) return null;
    ...
    GetMatchingToken(text, startIndex) {
        for (const token of this.Tokens) {
            if (text.indexOf(token, startIndex) == startIndex) {
                ...
                if (startIndex + token.length < text.length - 1 && text[startIndex + token.length].trim() != '')
                    continue;
                return token;
            }
        }
