...
Route::middleware(['auth', 'web'])->group(function () {
    Route::get('account/verify-email', [EmailVerificationPromptController::class, '__invoke'])
    ...
    Route::post('account/email/verification-notification', [EmailVerificationNotificationController::class, 'store'])
